    ...
    while cap.isOpened():
        ...
        try:
            ...
            if validate_rect(coords):   
                ...
                if not validation:
                    cv2.putText(frame, "Processing grid...", (frame_width//2 - 100, frame_height - 30), 
                ...
                if not validation:
                    ...
                    if isValidConfig(sudoku_matrix) and np.count_nonzero(sudoku_matrix)!=0:
                        ...
                        cv2.putText(frame, "Grid processed successfully!", (frame_width//2 - 150, frame_height - 30), 
                                  cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
                ...
                cv2.putText(frame, "Adjust grid position for better visibility", (frame_width//2 - 200, frame_height - 30), 
                          cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        
        except:
            # Show message when no grid is detected
            cv2.putText(frame, "No grid detected", (frame_width//2 - 100, frame_height - 30), 
                      cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
